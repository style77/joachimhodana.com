...
export const home = (props: React.FC) => {
  return (
...
export const shuffle = (props: React.FC) => {
  return (
...
export const previous = (props: React.FC) => {
  return (
...
export const next = (props: React.FC) => {
  return (
    <svg height={16} width={16} viewBox="0 0 16 16" {...props}>
...
export const repeat = (props: React.FC) => {
  return (
    <svg height={16} width={16} viewBox="0 0 16 16" {...props}>
...
export const play = (props: React.FC) => {
  return (
    <svg height={16} width={16} viewBox="0 0 16 16" {...props}>
...
export const pause = (props: React.FC) => {
  return (
    <svg height={16} width={16} viewBox="0 0 16 16" {...props}>
...
export const search = (props: React.FC) => {
  return (
    <svg
      height={24}
      width={24}
...
export const camera = (props: React.FC) => {
  return (
    <svg
      height={24}
      width={24}
...
export const view = (props: React.FC) => {
  return (
...
export const sort = (props: React.FC) => {
  return (
...
export const refresh = (props: React.FC) => {
  return (
...
export const New = (props: React.FC) => {
  return (
...
export const display = (props: React.FC) => {
  return (
    <svg viewBox="0 0 500 500" {...props}>
      <path
        stroke="currentColor"
...
export const personalize = (props: React.FC) => {
  return (
    <svg viewBox="0 0 500 500" {...props}>
      <path
        stroke="currentColor"
...
export const terminal = (props: React.FC) => {
  return (
    <svg
      width="48"
      height="48"
...
export const info = (props: React.FC) => {
  return (
...
export const taskSearch = (props: React.FC) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="-2 -1 26 26"
...
export const share = (props: React.FC) => {
  return (
    <svg viewBox="0 0 64 64" {...props}>
      <path
        stroke="#6c6c6c"
