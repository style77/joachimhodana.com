      ...
      <div className="min-h-screen flex flex-col z-[10] relative">
        ...
        <div className="flex flex-col w-full items-center">
          <div className="relative h-px w-8/12 bg-gray-700">
            <a className="absolute bottom-[-15px] left-1/2 transform -translate-x-1/2 rotate-[-12deg] py-2 px-4 rounded-full bg-red-800 text-gray-300 drop-shadow-[0_0_30px_rgba(255,255,255,0.25)]">Services</a>
          </div>
          <Cards />
