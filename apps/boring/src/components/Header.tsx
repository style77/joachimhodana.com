...
export default function Header() {
    return (
        <div className="flex flex-col items-center justify-center w-full mt-14 gap-2">
            ...
            <a
                className="flex items-center btn border border-red-700 bg-transparent hover:border-red-500 transition-all duration-300 drop-shadow-lg"
                href="https://calendly.com/hodanajoachim/30min"
                aria-label="Book a short call"
            >
                <span className="bg-gradient-to-r from-red-500 to-red-600 inline-block text-transparent bg-clip-text drop-shadow-lg">
                    Book Short Call
                </span>
                <IoOpenOutline className="text-red-500 ml-2" size={20} />
            </a>
        </div>
    );
}